...
public class WebShopNotification {

    private static  String CHANNEL_ID = "web_shop_notification_channel";
    private final int NOTIFICATIONN_ID =0;

    private NotificationManager mNotificationManagar;
    private Context mContext;

    public WebShopNotification(Context context) {
    ...
    public void send(String message){
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(mContext, CHANNEL_ID)
                .setContentText(message+" a kosárban")
