...
public class WebShopItemAdapter extends RecyclerView.Adapter<WebShopItemAdapter.ViewHolder> implements Filterable {
    ...
    public WebShopItemAdapter(Context mContext, ArrayList<WebShopItem> itemsData) {
    ...
    @NonNull
    @Override
    public WebShopItemAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.list_item,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull WebShopItemAdapter.ViewHolder holder, int position) {
