...
public class CartItemAdapterVert extends RecyclerView.Adapter<CartItemAdapterVert.ViewHolder> {

    private ArrayList<WebShopItem> mCartItemData;
    private Context mContext;
    private int lastPosition = -1;

    public CartItemAdapterVert(Context mContext, ArrayList<WebShopItem> itemsData) {
    ...
    @NonNull
    @Override
    public CartItemAdapterVert.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(mContext).inflate(R.layout.cart_item_vert,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull CartItemAdapterVert.ViewHolder holder, int position) {
